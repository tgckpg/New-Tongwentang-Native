void match_p_byte6(unsigned char const* str, int start, char const* &out, int &step_size);
void match_p_byte5(unsigned char const* str, int start, char const* &out, int &step_size);
void match_p_byte4(unsigned char const* str, int start, char const* &out, int &step_size);
void match_p_byte3(unsigned char const* str, int start, char const* &out, int &step_size);
void match_p_byte2(unsigned char const* str, int start, char const* &out, int &step_size);
void match_p_ascii(unsigned char const* str, int start, char const* &out, int &step_size);
